...
export const receipeNumber = css`margin-top: 15px;`
...
export const receipeShadow = css`
  background-color: #fff;
  box-shadow: 0 2px 25px 2px rgba(0, 0, 0, 1),
    0 2px 50px 2px rgba(0, 0, 0, 1), 0 0 100px 3px rgba(0, 0, 0, 0.25);
  height: 1px;
  margin: -1px auto 0;
  width: 80%;
  z-index: -1;
...
export const receipeSubtle = css`color: #aaa;`
